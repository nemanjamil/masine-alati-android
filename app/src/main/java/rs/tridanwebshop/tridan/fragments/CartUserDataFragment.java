...
//                    user.setFirmAddress();
    ...
    private void updateUserData() {
        ...
        Log.logDebug("onResponse1","error.networkResponse.toString()+error.getLocalizedMessage()+error.getMessage()");
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (success) {
                        ...
                        Log.logDebug("onResponse3","error.networkResponse.toString()+error.getLocalizedMessage()+error.getMessage()");
    ...
    private void completeTransaction() {
        ...
        StringRequest strReq = new StringRequest(Request.Method.GET,
            ...
            public void onErrorResponse(VolleyError error) {
                progressDialog.hideDialog();
                Log.logDebug("onResponse4",error.networkResponse.toString()+error.getLocalizedMessage()+error.getMessage());
...
//            jsonObject.accumulate("jezikId", 1);
            jsonObject.accumulate("jezikId", 5);
        ...
        JsonObjectRequest strReq = new JsonObjectRequest(Request.Method.POST,
            ...
            public void onErrorResponse(VolleyError error) {
                progressDialog.hideDialog();
                Log.logDebug("onResponse6",error.networkResponse.toString()+error.getLocalizedMessage()+error.getMessage());
