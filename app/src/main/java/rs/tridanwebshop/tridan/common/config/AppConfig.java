package rs.tridanwebshop.tridan.common.config;
...
//    public static final String URL_MACHINES_AND_TOOLS = "http://masinealati.rs/parametri.php";
        ...
        public static final String URL_MACHINES_AND_TOOLS = "http://masine.tridan.rs/parametri.php";
//    public static final String URL_MACHINES_AND_TOOLS = "http://masine.tridan.rs/parametri_new.php";
    ...
    public static final String URL_PRODUCTS_OF_THE_WEEK = "http://masine.tridan.rs/parametri.php?action=artNaAkciji&id=9&od=0&do=25";
    public static final String URL_ALL_BRENDS = "http://masine.tridan.rs/parametri.php?action=listaBrendova";
    public static final String URL_ALL_BRENDS_FRONT_PAGE = "http://masine.tridan.rs/parametri.php?action=sviBrendoviNaslovna";
    public static final String URL_YOU_MAY_ALSO_LIKE_CATEGORIES = "http://masine.tridan.rs/parametri.php?action=kategYouMayAlso&limit=10";
...
//            "&KomitentMatBr=%14$s&KomitentPIB=%15$s&KomitentFirmaAdresa=%16$s";//TODO
     ...
     * Cart
     */
    public static final String URL_GET_CART = "http://masine.tridan.rs/parametri.php?action=korpaLista&userId=%1$s";
    public static final String URL_ADD_CART_ITEM = "http://masine.tridan.rs/parametri.php?action=dodajArtikalKorpa&id=%1$s&br=%2$s&userId=%3$s";
    public static final String URL_DELETE_CART_ITEM = "http://masine.tridan.rs/parametri.php?action=obrisiArtikalKorpa&id=%1$s&userId=%2$s";
    public static final String URL_DELETE_ALL_CART_ITEMS = "http://masine.tridan.rs/parametri.php?action=obrisiSveKorpa&userId=%1$s";
    public static final String URL_UPDATE_CART_ITEM_QUANTITY = "http://masine.tridan.rs/parametri.php?action=dodajArtikalKorpa&id=%1$s&br=%2$s&userId=%3$s";
    public static final String GET_CART = "Korpa";
    public static final String URL_COMPLETE_TRANSACTION = "http://masine.tridan.rs/parametri.php?action=kupovinaKorpa&userId=%1$s";
    public static final String URL_COMPLETE_TRANSACTION_UNREGISTERED_USER = "http://masine.tridan.rs/parametri.php?action=kupovinaKorpaUnregistered";
